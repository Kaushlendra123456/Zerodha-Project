    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <br />
          <a href="">How to fill a complaints?</a>
          <br />
      ...
      <p>
        *Customers availing insurance advisory services offered by Ditto
        ...
        mechanism for such products. NSE BSE MCX Terms & conditions Policies &
        procedures Privacy policy Disclosure For investor's attention Investor
        charter
      </p>
      </div>
    </div>
